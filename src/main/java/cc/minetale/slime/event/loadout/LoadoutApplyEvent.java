...
public class LoadoutApplyEvent implements LoadoutEvent, PlayerEvent, CancellableEvent {
    ...
    public LoadoutApplyEvent(@NotNull Player player, @NotNull Loadout loadout) {
        this.player = player;
