...
public class LootPredicateSerializers {
    ...
    public static class LootPredicateDeserializer extends StdDeserializer<LootPredicate> {
        public LootPredicateDeserializer() {
            this(null);
        }

        public LootPredicateDeserializer(Class<?> vc) {
            super(vc);
        }
