...
public enum TeamType {
    ...
    GREEN(MC.CC.DARK_GREEN, "Green", "G",
            Material.GREEN_WOOL,
    ...
    WHITE(MC.CC.WHITE, "White", "W",
            ...
            Material.IRON_INGOT,
            Material.IRON_BLOCK),
    PINK(MC.CC.LIGHT_PURPLE, "Pink", "P",
            Material.PINK_WOOL,
    ...
    PURPLE(MC.CC.DARK_PURPLE, "Purple", "PU",
    ...
    LIME(MC.CC.GREEN, "Lime", "L",
            ...
            Material.SUGAR_CANE,
            Material.MELON),
    MAGENTA(MC.CC.LIGHT_PURPLE, "Magenta", "M",
